...
public interface ApplicationContextFactory {
	...
	ApplicationContextFactory DEFAULT = (webApplicationType) -> {
		try {
			// 去spring.factories中加载ApplicationContextFactory的实现类并遍历
			// spring.factories默认配置了servlet和reactive两种程序的Factory
			// Factory的create方法会判断传入的WebApplicationType，如果是跟自己相同的类型就创建context并返回，否则返回null
